...
<div style="width: 300px;"><a href="${cpath }/mypage/changeProfile">프로필 바꾸기</a></div>
...
<p>
    ...
    <input type="hidden" name="idx" id="idx" value="${login.idx }">
...
<p>
   <input type="text" name="phonenumber" placeholder="연락처 수정" value="${login.phonenumber }">
...
<script>
   ...
   async function passCheckHandler(){
      ...
      const url = '${cpath}/passCheck/' + newPassword.value
