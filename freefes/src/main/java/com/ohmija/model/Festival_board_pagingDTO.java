...
public class Festival_board_pagingDTO {
	...
	private Fes_searchDTO fes_search_dto = null;
	...
	public Fes_searchDTO getFes_search_dto() {
		return fes_search_dto;
	}

	public void setFes_search_dto(Fes_searchDTO fes_search_dto) {
		this.fes_search_dto = fes_search_dto;
	}
