        ...
        $.ajax({
            ...
            success: function(response) {
            	...
            	board_list.forEach(function(board) {
            		const formatted_start_date = formatDate(board.start_date)
            		const formatted_end_date = formatDate(board.end_date)
...
const grades = document.querySelectorAll(".board_grade")
