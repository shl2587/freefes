...
input[type="password"].join_userpw_text, input[type="date"].join_birth_date, select, input[type="email"]
	{
	width: 100%;
	padding: 12px;
...
.btn:hover, input[type="submit"].join_submit_btn:hover, #nickNameCheckBtn:hover,
	#emailBtn:hover {
	background-color: #07277d;
}
...
input[type="text"].join_userid_text, input[type="password"].join_userpw_text, input[type="text"].join_name_text,
 input[type="date"].join_birth_date, input[type="text"].join_nickname_text, input[type="text"].join_phonenumber, 
...
input[type="text"].email_front, input[type="text"].email_back_input, input[type="text"].email_back_input{
	padding: 10px;  /* 패딩 변경 */
	border: 1px solid #ddd;
	border-radius: 5px;
	font-size: 14px;
...
<form method="POST" id="joinFrom">
		<div class="join_list">
			...
			<div class="userid_div">
				<input type="text" name="userid" placeholder="아이디" class="join_userid_text" required onfocus>
				<br> <span id="dupMessage"></span>
			</div>

			<div class="password">
				<div class="password1">
					<input type="password" name="userpw" placeholder="비밀번호" class="join_userpw_text" requi>
				</div>
			...
			<div class="name">
				<input type="text" name="name" placeholder="이름" class="join_name_text" required>
			</div>
			...
			<div class="join_select_wm">
				<input type="radio" class="join_gender_ch" id="m" name="gender" value="m"><label
					for="m">남자</label> <input type="radio" class="join_gender_ch"  id="w"
					name="gender" value="w"><label for="w">여자</label>
			</div>
			...
			<div>
				<div class="nicknameBox">
					<input class="join_nickname_text" type="text" name="nickname" placeholder="닉네임" required> 
					<input id="nickNameCheckBtn" type="button" class="btn-info" value="닉네임 중복확인">
				</div>
			...
			<div class="email">
				...
				<div class="email_front">
					<input type="text" name="email_front" placeholder="E-Mail"
						class="email_front" required>
				</div>
				<div class="gol">@</div>
				<div class="email_back">
					<input type="text" class="email_back_input" name="email_back_input" id="email_back_input">
					<select class="email_back_input" id="email_back_select"
			...
			<div class="phonenumber">
				<input type="text" name="phonenumber" placeholder="전화번호" class="join_phonenumber" required>
			</div>
		<div class="verify1_join_allmost">
			...
			<input type="text" name="answer1" class="join_answer1" placeholder="답변1">
		</div>
		...
		<div class="verify2_join_allmost">
			...
			<div class="answer2">
				<input type="text" name="answer2" class="join_answer2" placeholder="답변2">
			</div>
		</div>
			<div>
...
async function emailCheckHandler() {
    ...
    const email_front = document.querySelector('input[name="email_front"]').value
    const email_back = document.querySelector('input[name="email_back_input"]').value
...
function updateEmailInput() {
    const selectedValue = document.getElementById("email_back_select").value;
