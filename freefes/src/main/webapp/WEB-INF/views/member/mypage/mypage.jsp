...
<div class="all">
	...
	<div><a href="${cpath }/member/mypage/mileageuselist/${login.idx}">마일리지 내역</a></div>
	<div><a href="${cpath }/member/mypage/list/${login.idx}">게시글 내역</a></div>
	<div><a href="${cpath }/member/mypage/reply/${login.idx}">댓글 내역</a></div>
	<div><a href="${cpath }/member/mypage/attend/${login.idx}">출석</a></div>
